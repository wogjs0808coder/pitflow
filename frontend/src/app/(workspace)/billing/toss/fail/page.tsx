...
export default async function TossFailPage({
  ...
  return <TossPaymentResult invoiceId={value("invoiceId")} orderId={value("pitflowOrderId") || value("orderId")} failure={value("message") || "결제가 완료되지 않았습니다."} admin={value("admin") === "1"} />;
}
